...
/**
 * =============================================================================
 * affinity_scorer_tb.v - File-Based AXI-Stream Testbench
 * =============================================================================
 * DVCon India 2026 - Stage 2B
 * Modeled on the Sobel edge detection testbench pattern:
 *   - Reads embedding vectors from .hex files (generated by export_test_vectors.py)
 *   - Streams bytes into DUT via AXI-Stream slave interface
 *   - Waits for o_intr, reads 6-byte result from master interface
 *   - Writes result to output file and checks against golden reference
 *
...
module top_tb_sv;
    ...
    // ─── Receive Output Bytes (like Sobel's always block for outData) ─────
    ...
    initial begin
        ...
        // (generated by export_test_vectors.py, placed in Vivado project dir)
        ...
        // Reset sequence (matches Sobel TB)
        #100;
        reset = 1'b1;
        #100;
        ...
        // Same pattern as Sobel TB waiting for intr between rows
        @(posedge intr);
